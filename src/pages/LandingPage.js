...
const LandingPage = () => {
    ...
    return (
        ...
        <div className="landing-wrapper">
                    ...
                    <img src={logo} className="logo" alt="babylon-layout"/>
                        ...
                        <span id="landing-menu-button">
                            {open === false ? (
                                ...
                                <ul className='ul-menu'>
                                    <li>
                                        <HashLink to='/#header'>Quem somos</HashLink>
                                    </li>
                                    <li>
                                        <HashLink to='/#features'>Áreas de atuação</HashLink>
                                    </li>
                                    <li>
                                        <HashLink to="/#promo">Equipe</HashLink>
                                    </li>
                                    <li>
            ...
            <div id="promo" style={{backgroundColor:'#fff', border:'none'}}>
